...
import { createCOScheduleOfValuesView } from './views/lineItemAssociation/coSOVView.config.js';
import { createCOLineItemAssociationView } from './views/lineItemAssociation/coLineItemAssociationView.config.js';
...
export const coScheduleOfValuesView = createCOScheduleOfValuesView(config);
export const coLineItemAssociationView = createCOLineItemAssociationView(config);
